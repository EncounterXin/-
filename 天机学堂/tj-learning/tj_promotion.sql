...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='用户领取优惠券的记录，是真正使用的优惠券信息';

-- 正在导出表  tj_promotion.user_coupon 的数据：~3 rows (大约)
DELETE
FROM `user_coupon`;
INSERT INTO `user_coupon` (`id`, `user_id`, `coupon_id`, `term_begin_time`, `term_end_time`, `used_time`, `status`,
                           `create_time`, `update_time`)
VALUES (1, 2, 1630563495906942978, '2023-03-01 18:28:19', '2023-03-21 18:28:19', NULL, 1, '2023-03-01 18:28:20',
        '2023-03-01 18:28:20'),
       (2, 5, 1630563495906942978, '2023-03-01 18:29:24', '2023-03-21 18:29:24', NULL, 1, '2023-03-01 18:29:24',
        '2023-03-01 18:29:24'),
       (3, 1, 1630563495906942978, '2023-03-01 18:33:29', '2023-03-21 18:33:29', NULL, 1, '2023-03-01 18:33:29',
        '2023-03-01 18:33:29');